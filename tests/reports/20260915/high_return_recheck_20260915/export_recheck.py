...
role=sys.argv[1];r=Path('/data1/lyb/fgac-lab' if role=='R' else '/home/lyb/fgac-lab');out=r/'runs/high-return-recheck-0915';d=r/'deploy/fgac-current'
secrets=[]
...
with (out/'spark-events-filtered.jsonl').open('w') as dest:
    for p in (r/'runs/native-baseline-0915/events').glob('*'):
