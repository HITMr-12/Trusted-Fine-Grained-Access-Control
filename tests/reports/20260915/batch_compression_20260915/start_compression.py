...
r=Path('/data1/lyb/fgac-lab');d=r/'deploy/fgac-batch-compression';p=r/'manifests/fgac-batch-compression.pid'
...
p=subprocess.Popen(['/home/lyb/tools/spark/bin/spark-submit','--conf','spark.eventLog.dir=file:/data1/lyb/fgac-lab/runs/batch-compression-0915/events',str(d/'serve_compression.py')],cwd=d,env=env,stdin=subprocess.DEVNULL,stdout=(r/'logs/fgac-batch-compression.log').open('a'),stderr=subprocess.STDOUT,start_new_session=True);print('Remote launcher PID',p.pid)
