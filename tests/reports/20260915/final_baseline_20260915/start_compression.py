...
r=Path('/data1/lyb/fgac-lab');d=r/'deploy/fgac-final-baseline';p=r/'manifests/fgac-final-baseline.pid'
...
p=subprocess.Popen(['/home/lyb/tools/spark/bin/spark-submit','--jars',jars,'--conf','spark.eventLog.dir=file:/data1/lyb/fgac-lab/runs/final-baseline-0915/events',str(d/'serve_compression.py')],cwd=d,env=env,stdin=subprocess.DEVNULL,stdout=(r/'logs/fgac-final-baseline.log').open('a'),stderr=subprocess.STDOUT,start_new_session=True);print('Remote launcher PID',p.pid)
