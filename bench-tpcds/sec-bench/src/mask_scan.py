...
from recv_server import fetch


def scan_digest(spark, root, request, business, *, host, port, ca):
    ...
    try:
        ...
        directory, manifest = fetch(root, request, host=host, port=port, ca=ca, on_file=on_file)
